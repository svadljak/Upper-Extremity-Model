 ...
 * File: _coder_Optimization_ThelenMuscle_codegen_api.c
 *
...
void Optimization_ThelenMuscle_codegen_atexit(void)
{
  ...
  Optimization_ThelenMuscle_codegen_xil_terminate();
  Optimization_ThelenMuscle_codegen_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
                                     ...
                                     const mxArray **plhs)
{
  ...
  Optimization_ThelenMuscle_codegen(*Q, *b, *Fl, *Fpe, *VM, *LM0, *a0, *alpha0,
                                    *FM0, *activation);
...
/*
 * File trailer for _coder_Optimization_ThelenMuscle_codegen_api.c
 *
 * [EOF]
 */
